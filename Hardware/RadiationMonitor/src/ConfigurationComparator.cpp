...
ConfigurationComparator::ConfigurationComparator(Configuration desired_configuration)
    : desired_configuration_(desired_configuration), is_initialised_(true) {}

ConfigurationComparator::~ConfigurationComparator() {}

void ConfigurationComparator::CheckIfOk() {
    if (!StatusRead()) {
        return;
    }
    if (mode_functionnement_correct_ &&
        ...
        qDebug() << "ConfigurationComparator::OK";
            emit Ok();
    } else {
        qDebug() << "ConfigurationComparator::WRONG";
        emit Wrong();
    }
}

bool ConfigurationComparator::StatusRead() const {
...
QMap<QString, QString> ConfigurationComparator::GetWrongParameters() {
